...
begin
  Qry.SQL.Clear;
  Qry.SQL.Add('SELECT * FROM ENTRADAS WHERE DHEMI BETWEEN :Dataini AND :DataFim UNION SELECT * FROM SAIDAS WHERE DHEMI BETWEEN :Dataini AND :DataFim');
  try
    Qry.Open;
    Result:= Qry;
  except
...
begin
  Qry.SQL.Clear;
  Qry.SQL.Add('SELECT * FROM SAIDAS WHERE DHEMI BETWEEN :Dataini AND :DataFim');
