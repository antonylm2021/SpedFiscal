...
//
          ...
          begin
            with Registro0100New do
              begin
                ...
                CPF := qContador.FieldByName('CPF').AsString; // Deve ser uma informação valida
      ...
      if QParticipantes.IsEmpty then
       ShowMessage('Não há Participantes neste período faças a importanção dos XMLS')
       else
      begin
  ...
  //                  end;
      ...
      QNotas := TUniQuery.Create(nil);
      Notas:= TEntradaRepositorio.create;
      QNotas:= Notas.ListarObservaçõesComplementar('ENTRADAS');
      int0450:=0;
      ...
      if Not QNotas.IsEmpty then
       ...
       QNotas := TUniQuery.Create(nil);
       Notas:= TEntradaRepositorio.create;
       QNotas:= Notas.ListarObservaçõesComplementar('SAIDAS');
       int0450:=0;
